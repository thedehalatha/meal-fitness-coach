...
async def test_agent_stream_query(agent_app: AgentEngineApp) -> None:
    ...
    message = "Create a meal plan and workout routine for a 30-year-old male. Height: 180cm, Current weight: 70kg, Target weight: 65kg, Activity level: sedentary, Dietary preferences: none, Goal: lose weight."
    events = []
